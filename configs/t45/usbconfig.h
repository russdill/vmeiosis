 ...
 */
#define USB_CFG_SUPPRESS_INTRIN_ENDPOINTS 1
/* Define this to 1 if you want interrupt-in handling code, but don't want
 * to declare any interrupt in endpoints. */
 ...
 */
#define USB_CFG_MSGPTR_EEPROM           1
 ...
 * the implications!
 */
#define USB_CFG_DEVICE_VERSION  VME_MINOR, VME_MAJOR
/* Version number of the device: Minor number first, then major number.
 */
#define USB_CFG_VENDOR_NAME     'r', 'u', 's', 's', 'd', '@', 'a', 's', 'u', \
                                '.', 'e', 'd', 'u'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'v', 'm', 'e'
...
#define USB_INTR_PENDING_BIT    PCIE
...
#if USB_INTR_ENABLE_BIT != INT0 /* No point in chaining INT0, it's single function */
#define USB_INTR_CHAIN \
     sbis    USB_GPIOR(VME_MODE_GPIOR_IDX), VME_MODE_GPIOR_BIT $\
     rjmp    user_vector
#endif
